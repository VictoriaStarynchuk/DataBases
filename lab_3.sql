...
CREATE INDEX fk_city_country1_idx ON city(country_id);
CREATE INDEX fk_business_land_city1_idx ON business_land(city_id);
CREATE INDEX fk_owner_has_business_land_business_land1_idx ON owner_businessland(business_land_id, owner_id);
CREATE INDEX fk_element_panel1_idx ON element(panel_id, battery_id);
CREATE INDEX fk_station_energy1_idx ON station(energy_id, element_id, business_land_id);
CREATE INDEX fk_energy_market_energy1_idx ON energy_market(energy_id);


SHOW INDEX FROM city;
SHOW INDEX FROM business_land;
SHOW INDEX FROM owner_businessland;
SHOW INDEX FROM element;
SHOW INDEX FROM station;
SHOW INDEX FROM energy_market;
